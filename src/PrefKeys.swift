...
enum PrefKeys: String {
    case loginWindowHeight, loginWindowWidth, clientID,scopes,discoveryURL,shouldSetGoogleAccessTypeToOffline,clientSecret, resources,tokenEndpoint,redirectURI,resource,loginWindowBackgroundImageURL,idpHostName,passwordElementID,shouldUseBasicAuth,idpHostNames,shouldAllowExitSAM,wifiNetworks,shouldShowSystemInfoButton,shouldExitOnSuccessfulAuth,showDebug,googleHostDomain,loadPageTitle,loadPageInfo,shouldActivateSystemInfoButton,systemInfoButtonTitle, notificationReminderTimerSeconds, webHookAuthToken, webHookURLString, deviceSerial, productKbaseURLString, shouldHideOIDCResults, shouldShowSettingsButton
}
...
//    case shouldAllowExitSAM = "shouldAllowExitSAM"
//
//}
